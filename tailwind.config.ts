...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        "display-lg": ["4.5rem", { lineHeight: "1.03", letterSpacing: "-0.035em" }],
        display: ["3.5rem", { lineHeight: "1.06", letterSpacing: "-0.032em" }],
        "display-sm": ["2.5rem", { lineHeight: "1.1", letterSpacing: "-0.028em" }],
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
